---
title: Como dar update no NodeJS - um tutorial fácil e rápido
excerpt: Afinal, saber como atualizar Node é importantíssimo, ainda mais quando se usa terminal.
...
Mas, se as outras opções não deram certo e você estiver desesperado, existe a possibilidade de ir para a [página oficial de downloads](https://nodejs.org/en/download?ref=yagasaki.dev/blog) para conseguir um pacote binário 32-bit ou 64-bit para dar update NodeJS ou instalar.
...
Você pode começar essa jornada acessando a [página de downloads do Node](https://nodejs.org/en/download?ref=yagasaki.dev/blog), afinal, lá é possível encontrar pacotes binários para atualizar Node Windows e para o MacOS.
