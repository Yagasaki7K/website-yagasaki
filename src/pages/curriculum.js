        ...
        <CurriculumDetails>
            <div className="LeftContent">
                ...
                <div className="ContentText">
                    ...
                    <p>
                        Developer with experiences in Javascript, React, NextJS,
                        Typescript, Styled Components, SASS, Firebase,
            ...
            <div className="RightContent">
                ...
                <div className="content">
                    ...
                    <p className="description">
                        ...
                        Brewery, Healthcare, Journalism, Sustainability,
                        Sales/Entrepreneurship, Podcasts and Sports Electronic.
                    </p>
                ...
                <div className="content">
                    ...
                    <p>
                        Working in A.I. and e-commerce applications. Using:
                        React, NextJS, TypeScript, NodeJS, GraphQL, Hasura,
                        UI/UX, Storybook, Figma, ChakraUI, CI/CD, Unit and
                        Integration Tests, AWS Cloud, and Postgress
                    </p>
                </div>

                <div className="content">
                    <hr />
                    <strong>SYSTEMS DEVELOPMENT ANALYST</strong> <br /> at
                    Cenário Capital
                    <p>April 2021 — September 2021</p>
                    <i>
                        Letter of Recommendation by Alexandre Carvalho Rezende
                        (CEO) can be requested
                    </i>
                    <p>
                        Cenário Capital https://cenariocapital.com.br/ is a
                        Brazilian company Founded in 2008 with expertise in
                        digital marketing and analytical focus on different
                        types of digital business. We help Brazilians to make
                        the best decisions, with information and digital
                        solutions, through their various brands of the group!
                    </p>
                    <ul>
                        <li>
                            Responsible for the website development and e-mails
                            marketing of the project.
                        </li>
                        <li>New features and homepage development</li>
                        <li>
                            Development of customer review questionnaire system
                            using NextJS and Typescript
                        </li>
                        <li>
                            Push notification development using Javascript via
                            Google Developers
                        </li>
                        <li>
                            Scrum / Kabam during development and project
                            completion
                        </li>
                        <li>
                            Installation and repair of Google Analytics /
                            Facebook Ads in marketing team monitoring
                        </li>
                        <li>
                            DevOps in system installation, building and caching
                            (DigitalOcean).
                        </li>
                        <li>
                ...
                <div className="content">
                    <hr />
                    <strong>
                        JUNIOR MARKETING ASSISTANT / DEVELOPMENT FRONT END{" "}
                    </strong>{" "}
                    <br />
                    at Marry Perry Paris
                    <p>July 2020 – October 2020</p>
                    <p>
                        I was responsible for the development of several landing
                        pages for the company, including the main website, how
                        to use each product website and several other segments
                        for customer communication. I was assigned as a Junior
                        Developer during the creation of a system that lasted
                        only two months until the end of the contract, the
                        project would be an affiliate platform for the company
                        that was later discontinued, using MVC Architecture,
                        MySQL and NodeJS – later the project was changed to
                        Laravel
                    </p>
                    <ul>
                        ...
                        <li>
                            Landing page on how to use each pharmaceutical
                            product
                        </li>
                        <li>
                            Affiliate platform development using Laravel and
                            MySQL
                        </li>
                        <li>
                            Development of the improved version of the platform
                ...
                <div className="content">
                    ...
                    <ul>
                        ...
                        <li>
                            Beer raw material replacement solution for an
                            economical and sustainable reactor
                        </li>
                ...
                <div className="content">
                    ...
                    <ul>
                        <li>
                            New features and homepage development with React,
                            NextJS and Vite
                        </li>
                        ...
                        <li>
                            <s>Encyclopedia for Beginner Developers (4chell)</s>
                        </li>
                        <li>
                            Developer community management / Kalify Community
                        </li>
                        <li>Creating events and helping the community</li>
                        <li>
                            Development of the first consumer page of the Filipe
                            Deschamps Newsletter
                        </li>
                ...
                <div className="content">
                    ...
                    <ul>
                        <li>
                            Resource creation and development of
                        ...
                        <li>
                            Building Eccaplan&apos;s blockchain and tradecenter
                            (Carbon Fair)
                        </li>
                    </ul>
                </div>
                ...
                <div className="content">
                    ...
                    <ul>
                        <li>New features and homepage development</li>
                        <li>
                            Installation and repair in Google Analytics /
                            Facebook Ads in the monitoring of the marketing team
                        </li>
                        <li>
                            DevOps in system installation, building and caching
                        </li>
                ...
                <div className="content">
                    <hr />
                    <strong>DEVELOPER FRONT-END</strong> <br /> at
                    YouConnectStart
                    <p>March 2020 — May 2020</p>
                    <ul>
                        <li>New features and homepage development</li>
                ...
                <div className="content">
                    ...
                    <p>
                        ...
                        by Instituto de Gestão e Tecnologia da Informação (IGTI)
                        - November 2021
                    </p>
                    <p>
                        <strong>
                            Participation, Masterclass Github Actions{" "}
                        </strong>
                    ...
                    <p>
                        <strong>
                            Facebook Blueprint from Basic to Advanced{" "}
                        </strong>
                    ...
                    <p>
                        <strong>
                            Getting Started with Github and Essential Commands{" "}
                        </strong>
                        by Digital Innovation One - February 2020
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>
                            Internet programming with HTMl5 and CSS3{" "}
                        </strong>
                        by Digital Innovation One - February 2020
                    </p>
                    <p>
                        <strong>
                            Web Programming for Scientific Dissemination{" "}
                        </strong>
                    ...
                    <p>
                        <strong>
                            Illustration and Graphic Design for the Web{" "}
                        </strong>
