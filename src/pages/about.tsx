			...
			<AboutDetails>
				<article>
					...
					<div id="career">
						...
						<li>Led the development of internal platforms using Node.js and React, successfully reducing the execution time of core internal processes by 35%.</li>
						<li>Engineered AI-powered solutions integrated with the WhatsApp Business API and OpenAI, doubling the accuracy of personalized customer responses.</li>
						<li>Implemented a Stripe payment system that boosted annual plan conversion by 28% and developed a feedback system that increased customer satisfaction by 40%.</li>
						<p className="description">Using Express, Node.js, OpenAI API, WhatsApp API, Facebook Business API, Next.js, Discord Webhook, AstrologyAPI, Stripe and Python</p>

						<h3 className="titleJob">
							<strong>Software Engineer II</strong> @ WhatsUpper | Aug 2023 - Dec 2023
						</h3>
						<li>Specialized in developing and integrating intelligent automation solutions for the WhatsApp Business API, enhancing customer communication workflows.</li>
						<li>Built and maintained scalable backend services using Node.js to process high volumes of messages and power interactive chatbot experiences.</li>
						<li>
							Collaborated with cross-functional teams to design and implement custom features, focusing on improving user engagement and retention through the WhatsApp
							channel.
						</li>
						...
						<li>Optimized DialogFlow routines and integrated them with Rocket.Chat, improving chatbot response speed by over 50% and increasing customer retention.</li>
						<li>Developed an interactive SPA with jQuery to automate customer routing and enable WhatsApp-based checkouts, cutting down queue times by up to 20%.</li>
						<li>Authored comprehensive documentation for system architectures and internal processes, ensuring scalability and simplifying future maintenance.</li>
						<p className="description">Using Rocket.chat, Hasura, Next.js, WhatsApp API, Facebook Business API, Twilio, Firebase, DialogFlow and Google Cloud Plataform</p>

						<h3 className="titleJob">
							<strong>Systems Development Analyst I/II</strong> @ Cenário Capital | Oct 2020 - Sep 2021
						</h3>
						<li>Developed and maintained critical financial systems, contributing to data analysis and process automation to support investment strategies.</li>
						<li>
							Collaborated with analysts and stakeholders to gather requirements and translate them into functional software solutions, improving operational efficiency through
							web quiz.
						</li>
						<li>Progressed from a Junior to a Mid-level role by demonstrating strong technical skills in system design, database management, and backend development.</li>
						...
						<li>Developed and enhanced the user interface (UI) of the e-commerce platform, focusing on creating a responsive and intuitive shopping experience.</li>
						<li>Implemented front-end features and optimizations that contributed to improved user engagement and conversion rates.</li>
						<li>Assisted the marketing team with technical tasks, including landing page creation, email template coding, tracking analytics and afiliates system.</li>
						...
						<li>Developed strong discipline, resilience, and the ability to perform effectively in high-pressure, structured environments.</li>
						<li>Mastered teamwork and communication skills through collaborative daily operations and mission-critical exercises with a diverse team.</li>
						<li>Demonstrated a high degree of responsibility and commitment while managing assigned communication equipment and executing duties with precision.</li>
					</div>
					...
					<div id="awards">
						...
						<p className="certificate">
							<strong className="text-gray-50">Introduction to automation with n8n</strong> by Enzzo Panarotto in Rocketseat - September 2025
						</p>
						...
						<p className="certificate">
							<strong className="text-gray-50">NLW Expert (Node, TS, Fastify, Prisma, Docker, PostgreSQL, Redis, Zod & WebSocket) </strong>
						...
						<p className="certificate">
							<strong className="text-gray-50">Agile Days </strong>by Instituto de Gestão e Tecnologia da Informação (IGTI) - November 2021
						</p>
