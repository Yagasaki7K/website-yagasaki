    ...
    return (
        <div className={style}>
            ...
            <div className="content-about">
                <h2>I'm Yagasaki,</h2>
                <h2>Frontend / Full Stack Software Developer (Typescript, React.js, Node.js) at Stone Co. from Campinas, Brazil</h2>
                <div className="quote">
                    <p><b>❝</b> <u>Science</u> without results is just <u>witchcraft</u><b>❞</b> — Cave Johnson</p>
                </div>

                <p>I am a <strong>code enthusiast</strong>, specialized for <strong>web</strong>. I'm Focused on modern technologies using Javascript and building great products and solutions alone or together with Kalify Inc. Persistent, dedicated and reliable worker, personally very communicative and friendly.</p>
                ...
                <div className="languages">
                    ...
                    <p><strong>Database:</strong> Firebase</p>
                    <p><strong>Testing:</strong> Jest</p>
                    <p><strong>DevOps:</strong> Docker, CI/CD</p>
                    <p><strong>Design:</strong> Figma, UX/UI</p>
                    <p><strong>Other:</strong> Git, Serverless, Vercel, etc...</p>
                </div>
                ...
                <div className="positions">
                    ...
                    <p><strong>Linx/Stone Co.</strong> | <i>October 2022 — Currently</i></p>
                    ...
                    <p><strong>Cenário Capital</strong> | <i>April 2021 — September 2021</i></p>
                    <p>Cenário Capital is a Brazilian company Founded in 2008 with expertise in digital marketing and analytical focus on different types of digital business. We're using technologies like NextJS, Typescript, Push Notification using Javascript via Google Developers, Scrum and Kabam during development, Google Analytics, Facebook Ads and using Digital Ocean to DevOps our system. <br /><br />Project available at <Link href="https://credits.com.br/">https://credits.com.br/</Link></p>

                    <h4>Junior Marketing Assistant / Development Frontend</h4>
                    <p><strong>Marry Perry Paris</strong> | <i>July 2020 – October 2020</i></p>
                    <p>I was responsible for the development of several landing pages for the company, including the main website, how to use each product website and several other segments for customer communication using MVC Architecture, MySQL and NodeJS – later the project was changed to Laravel</p>
                </div>
