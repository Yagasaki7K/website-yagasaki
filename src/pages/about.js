    ...
    return (
        <div className={style}>
            ...
            <div className="content-about">
                <h2>I'm Yagasaki,</h2>
                <h2>
                    Frontend / Full Stack Software Developer (Typescript,
                    React.js, Node.js) at Stone Co. from Campinas, Brazil
                </h2>
                <div className="quote">
                    <p>
                        <b>❝</b> <u>Science</u> without results is just{" "}
                        <u>witchcraft</u>
                        <b>❞</b> — Cave Johnson
                    </p>
                </div>
                ...
                <p>
                    ...
                    <strong>web</strong>. I'm Focused on modern technologies
                    using Javascript and building great products and solutions
                    alone or together with Kalify Inc. Persistent, dedicated and
                    reliable worker, personally very communicative and friendly.
                </p>
                ...
                <div className="positions">
                    ...
                    <p>
                        <strong>Linx/Stone Co.</strong> |{" "}
                        <i>October 2022 — Currently</i>
                    </p>
                    <p>
                    ...
                    <p>
                        Cenário Capital is a Brazilian company Founded in 2008
                        with expertise in digital marketing and analytical focus
                        on different types of digital business. We're using
                        technologies like NextJS, Typescript, Push Notification
                        using Javascript via Google Developers, Scrum and Kabam
                        during development, Google Analytics, Facebook Ads and
                        using Digital Ocean to DevOps our system. <br />
                        <br />
                        Project available at{" "}
                        <Link href="https://credits.com.br/">
                    ...
                    <p>
                        <strong>Marry Perry Paris</strong> |{" "}
                    ...
                    <p>
                        ...
                        for customer communication using MVC Architecture, MySQL
                        and NodeJS – later the project was changed to Laravel
                    </p>
                </div>
            ...
            <div className="footer">
                ...
                <div className="footer_center">
                    ...
                    <Link href="https://linkedin.com/in/andersonmarlon">
                        Linkedin
                    </Link>
                    <Link href="https://twitter.com/Yagasaki7K">Twitter</Link>
