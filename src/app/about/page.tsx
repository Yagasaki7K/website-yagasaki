		...
		<>
			...
			<article>
				...
				<div id="career">
					...
					<h3 className="mb-3">
						<strong className="text-sky-500">Software Engineer II</strong> @ Stone | Oct 2022 - Jul 2023
					</h3>
					<li className="mb-1">
				...
				<div id="awards">
					...
					<p className="mb-2">
						<strong className="text-sky-500">Technical Leadership (Tech Lead) </strong>
						by Sérgio Fiorotti in Rocketseat - February 2025
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">How to build a Micro SasS with Next.js, Firebase, Google Analytics and Stripe </strong>
						by Rocketseat - January 2025
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Build a web API with Node.js and Express </strong>
					...
					<p className="mb-2">
						<strong className="text-sky-500">NLW Journey - React (Tailwind, React) </strong>
						by Rocketseat - July 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Web Development with Python: Python, Django, Pytest & OOP </strong>
						by IBM SkillsBuild - June 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Firebase: Realtime Database, Cloud, Auth and Security </strong>
						by Gabriel Barreto - May 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">NLW Unite (Node, Typescript, Fastify, Prisma, Zod & Swagger) </strong>
						by Rocketseat - April 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">NLW Unite (React, Vite, TypeScript, Styled Components, Unicons & Dayjs) </strong>
						by Rocketseat - April 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">NLW Expert (Node, TS, Fastify, Prisma, Docker, PostgreSQL, Redis, Zod & WebSocket) </strong>
						by Rocketseat - February 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">NLW Expert (React, TS, Vite, TailwindCSS, Web Storage & Web Speech) </strong>
						by Rocketseat - February 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">1st Kyorugui Arbitration Seminar </strong>
						by Nova FETESP - February 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">4th Kombat Taekwondo Referee Siminar </strong>
						by Kombat Taekwondo - January 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">TDD – Guided Software Development Tests </strong>
						by Instituto Tecnológico de Aeronáutica (Coursera Free) - December 2023
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Complete Dialogflow - Master the Creation of Virtual Assistants </strong>
						by Universidade Global, Rogerio Guimaraes - November 2023
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Modern Web with Projects (JS/Typescript/React/Node) </strong>
						by COD3R - August 2022
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Workshop Figma </strong>by Design Culture - April 2022
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Introduction and Complete Course in Computer Science </strong>
						by Harvard - March 2022
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Participation, Proud Tech </strong>
						by Softplan - March 2022
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Agile Days </strong>by Instituto de Gestão e Tecnologia da Informação (IGTI) - November 2021
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Participation, Masterclass Github Actions </strong>
						by Azure na Prática - January 2021
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Participation, Hackathon (Third Place) </strong>
						by Shawee, AMBEV Hackathon - December 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Linux Terminal </strong>by Profº Diego Mariano - October 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Introduction to the Linux Operation System </strong>
						by Profº Diego Mariano - October 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Introduction to MySQL Database </strong>
						by Profº Diego Mariano - October 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Creating Dynamic Web Pages with PHP </strong>
						by Profº Diego Mariano - October 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Facebook Blueprint - Basic to Advanced </strong>
						by Faculdade do Marketing Digital - July 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">11th Edition - Omnistack Week </strong>
						by Rocketseat - March 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Introduction to Git and Version Control </strong>
						by Digital Innovation One - February 2020
					</p>

					<p>
						<strong className="text-sky-500">Getting Started with Git and Your Commands </strong>
						by Digital Innovation One - February 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Arctic Code Vault Contributor </strong>
						by Github Archive Program - February 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Essential Programming Logic </strong>
						by Digital Innovation One - February 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Internet programming with HTML5 and CSS3 </strong>
						by Digital Innovation One - February 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Web Programming for Scientific Dissemination </strong>
						by Profº Diego Mariano - January 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Web Design with PHP, HTML, CSS and JS </strong>
						by Udemy - January 2020
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Illustration and Graphic Design for the Web </strong>
						by Bradesco - May 2017
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">Web Design and Graphic Design </strong>
