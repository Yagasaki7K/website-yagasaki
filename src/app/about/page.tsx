		...
		<>
			...
			<article>
				...
				<div id="career">
					...
					<h3 className="mb-3">
						<strong className="text-gray-50">Software Engineer II</strong> @ Astriia | Sep 2024 - May 2025
					</h3>
					...
					<h3 className="mb-3">
						<strong className="text-gray-50">Software Engineer II</strong> @ WhatsUpper | Aug 2023 - Dec 2023
					</h3>
					<li className="mb-1">
					...
					<h3 className="mb-3">
						<strong className="text-gray-50">Software Engineer II</strong> @ Stone | Oct 2022 - Jul 2023
					</h3>
					<li className="mb-1">
					...
					<h3 className="mb-3">
						<strong className="text-gray-50">Systems Development Analyst I/II</strong> @ Cenário Capital | Oct 2020 - Sep 2021
					</h3>
					...
					<h3 className="mb-3">
						<strong className="text-gray-50">Front-end Developer I / Jr. Marketing</strong> @ Marry Perry | Feb 2020 - Sep 2020
					</h3>
					...
					<h3 className="mb-3">
						<strong className="text-gray-50">Soldier</strong> @ Brazilian Army | Mar 2016 - Apr 2017
					</h3>
