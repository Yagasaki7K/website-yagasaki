export default function AboutPage() {
	return (
		<>
			<h1 className="mb-10 mt-4 text-center max-sm:text-4xl text-5xl">
				About me
			</h1>
			<article>
				<h1>
				...
				<div>
					...
					<p>
						<strong>Other:</strong> Git, Serverless, Google Cloud, Docusaurus,
						etc...
					</p>
				</div>
				...
				<div id="awards">
					...
					<p className="mb-2">
						<strong className="text-purple-500">NestJS </strong>by Jornada do
						Dev - April 2025
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							How to build a Micro SasS with Next.js, Firebase, Google Analytics
							and Stripe{" "}
						</strong>
					...
					<p className="mb-2">
						<strong className="text-purple-500">NLW Journey - GO </strong>by
						Rocketseat - July 2024
					</p>

					<p className="mb-2">
						<strong className="text-purple-500">NLW Journey - NodeJS </strong>by
						Rocketseat - July 2024
					</p>

					<p className="mb-2">
						<strong className="text-purple-500">NLW Journey - Java </strong>by
						Rocketseat - July 2024
					</p>

					<p className="mb-2">
						<strong className="text-purple-500">NLW Journey - Python </strong>by
						Rocketseat - July 2024
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							NLW Unite (React, Vite, TypeScript, Styled Components, Unicons &
							Dayjs){" "}
						</strong>
						by Rocketseat - April 2024
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							NLW Expert (Node, TS, Fastify, Prisma, Docker, PostgreSQL, Redis,
							Zod & WebSocket){" "}
						</strong>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							NLW Expert (React, TS, Vite, TailwindCSS, Web Storage & Web
							Speech){" "}
						</strong>
						by Rocketseat - February 2024
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							1st Kyorugui Arbitration Seminar{" "}
						</strong>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							4th Kombat Taekwondo Referee Siminar{" "}
						</strong>
					...
					<p className="mb-2">
						...
						by Instituto Tecnológico de Aeronáutica (Coursera Free) - December
						2023
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">Workshop Figma </strong>by
						Design Culture - April 2022
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							Participation, Proud Tech{" "}
						</strong>
						by Softplan - March 2022
					</p>

					<p className="mb-2">
						<strong className="text-purple-500">Agile Days </strong>by Instituto
						de Gestão e Tecnologia da Informação (IGTI) - November 2021
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							Participation, Hackathon (Third Place){" "}
						</strong>
						by Shawee, AMBEV Hackathon - December 2020
					</p>

					<p className="mb-2">
						<strong className="text-purple-500">Linux Terminal </strong>by Profº
						Diego Mariano - October 2020
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							Facebook Blueprint - Basic to Advanced{" "}
						</strong>
					...
					<p>
						<strong className="text-purple-500">
							Getting Started with Git and Your Commands{" "}
						</strong>
						by Digital Innovation One - February 2020
					</p>
					...
					<p className="mb-2">
						<strong className="text-purple-500">
							Web Design with PHP, HTML, CSS and JS{" "}
						</strong>
