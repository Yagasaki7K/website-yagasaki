		...
		<>
			...
			<article>
				...
				<div id="awards">
					...
					<p className="mb-2">
						<strong className="text-sky-500">NestJS </strong>by Jornada do Dev -
						April 2025
					</p>
					...
					<p className="mb-2">
						<strong className="text-sky-500">NLW Journey - GO </strong>by
						Rocketseat - July 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">NLW Journey - NodeJS </strong>by
						Rocketseat - July 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">NLW Journey - Java </strong>by
						Rocketseat - July 2024
					</p>

					<p className="mb-2">
						<strong className="text-sky-500">NLW Journey - Python </strong>by
						Rocketseat - July 2024
					</p>
					...
					<p className="mb-2">
						<strong className="text-sky-500">Workshop Figma </strong>by Design
						Culture - April 2022
					</p>
					...
					<p className="mb-2">
						<strong className="text-sky-500">Agile Days </strong>by Instituto de
						Gestão e Tecnologia da Informação (IGTI) - November 2021
					</p>
					...
					<p className="mb-2">
						<strong className="text-sky-500">Linux Terminal </strong>by Profº
