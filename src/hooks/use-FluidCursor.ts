...
const useFluidCursor = () => {
    ...
    if (!canvas) {
        console.warn('Canvas element with id "fluid" not found');
        return;
    }
    ...
    if (!gl || !ext) {
        console.warn('WebGL context or extensions not supported');
        return;
    }
    ...
    function supportRenderTextureFormat(gl, internalFormat, format, type) {
      if (!gl || !internalFormat || !format || !type) {
        return false;
      }
