...
Caso você deseje utilizar esse conteúdo como uma fonte de estudos ao invés de uma revisão, eu sugiro acompanhar o
[repositório original](https://github.com/Yagasaki7K/courses/tree/main/course-go-first-steps), aonde estarão sendo
manutenções e melhorias de acordo com as necessidades, além de claro, estar separado por tópico em uma leitura menos
cansativa.
