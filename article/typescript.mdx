...
excerpt: Se você não é um desenvolvedor de JavaScript, provavelmente não deve ter ouvido falar sobre o TypeScript.
...
tags: ['NodeJS', 'TypeScript', 'Iniciante']
date: '2023-04-25'
---
...
A única fonte utilizada foi a [documentação oficial do TypeScript](https://www.typescriptlang.org/docs?ref=yagasaki.dev/blog).