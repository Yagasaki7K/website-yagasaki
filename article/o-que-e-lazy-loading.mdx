...
excerpt: 'Lazy loading é uma teoria de otimização de desempenho que ajuda o usuário a reduzir o tempo de carregamento inicial e melhorar a experiência do usuário.'
